...
const rightScroll =()=>{
  ...
  return (
    <>
        <div className="w-full md:w-[80%] mx-auto py-3 px-4 md:px-0 flex justify-between items-center mt-2">
         <h2 className=" text-2xl font-semibold pb-2 border-b-[1.5px] border-[#4681f4]">Bollywood</h2>
